...
//  evtx.h
//
//  Structures and Definitions for Windows Event Logs
//---------------------------------------------------------------------------------------------------------------------
#pragma once
#include <windows.h>
#include <stdint.h>
...
//---------------------------------------------------------------------------------------------------------------------
#define EVTX_PATH               L"C:\\Windows\\System32\\winevt\\Logs" // logs location
...
typedef struct _EVTX_EVENT_RECORD {
    uint32_t Signature;                                     // signature value (see above)
